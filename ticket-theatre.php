<?php
require_once __DIR__ . '/classes/TicketTheatre.class.php';

// Si on est pas en post, alors on redirige sur la page d'index   
if ($_SERVER["REQUEST_METHOD"] != "POST") {
    header('Location: index-theatre.php');
}
...
$ticketCinema = new TicketTheatre(
    $_POST["piece"],
    $_POST["date"],
    $_POST["place"],
    $_POST["tarif"],
                ...
                <section class="card-cont">
                    ...
                    <div class="even-date">
                        ...
                        <time>
                            ...
                            <span>
                                Heure de debut:
                                <?php echo $ticketCinema->getHeureDebut() ?>
                            </span>
                            <span>
                                Heure de d'entracte:
                                <?php echo $ticketCinema->getHeureEntracte() ?>
                            </span>
                        </time>
                    </div>
                    <div class="even-info">
